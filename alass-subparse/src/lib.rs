...
#![forbid(unsafe_code)]
#![deny(missing_docs, missing_copy_implementations, trivial_numeric_casts, unstable_features)]
...
//!
//! This is a vendored, modernized fork of `subparse 0.7.0`; see `README.md` for the
//! differences.
...
pub use crate::formats::idx::IdxFile;
pub use crate::formats::microdvd::MdvdFile;
pub use crate::formats::srt::SrtFile;
pub use crate::formats::ssa::SsaFile;
pub use crate::formats::vobsub::VobFile;
pub use crate::formats::{
    SubtitleFile, SubtitleFormat, get_subtitle_format, get_subtitle_format_by_extension,
    get_subtitle_format_by_extension_err, get_subtitle_format_err, is_valid_extension_for_subtitle_format, parse_bytes,
    parse_str,
};
